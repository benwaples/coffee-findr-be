...
app.post('/favorites', async(req, res) => {
  try {
    ...
    const data = await client.query(`
        ...
        RETURNING * 
      `, [favoriteList.biz_id, favoriteList.title, favoriteList.img, favoriteList.address, favoriteList.is_closed, favoriteList.rating, favoriteList.yelp_url, favoriteList.notes, 1]);
